    ...
    <>
      ...
      >
        <form onSubmit={handleSubmit} style={{ marginTop: "4%" }}>
          <Typography style={{ marginLeft: "7%" }} variant="h3" gutterBottom>
            Price $
          </Typography>
          ...
          <TextField
            ...
            helperText={
              priceFromError ? "Price From should not be negative" : ""
            }
          ...
          <InputLabel
            style={{ marginLeft: "10%", width: "29em" }}
